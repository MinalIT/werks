...
import AirpodmaxRed from './Images/Airpodred.png';
import AirpodmaxGreen from './Images/Airpodgray.png';
import AirpodmaxBlue from './Images/Airpodblue.png';
...
const ProductPage = () => {
  ...
  const [selectedColor, setSelectedColor] = useState(AirpodmaxRed);
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex space-x-4 mt-4">
              <button
                ...
                onClick={() => changeColor(AirpodmaxRed)}
              ></button>
              <button
                className="w-10 h-10 rounded-full bg-gray-500"
                onClick={() => changeColor(AirpodmaxGreen)}
              ></button>
              <button
                className="w-10 h-10 rounded-full bg-blue-500"
                onClick={() => changeColor(AirpodmaxBlue)}
              ></button>
            </div>
          </div>
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Airpods Max</h2>
            <p className="text-xl mt-2 text-green-600">₹549.00 or 99.99/month</p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">Airpods Max</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color Options</td>
                <td className="p-2">Red, Green, Blue</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Audio Technology</td>
                <td className="p-2">High-Fidelity Audio</td>
              </tr>
            </tbody>
          </table>
              {/* Publisher Info */}
      <h3 className="text-2xl font-bold mt-1 mb-1">Publisher Info</h3>
          <p className="text-sm text-gray-700"> A perfect balance of exhilarating high-fidelity audio and the effortless magic of AirPods.
            Published by Apple Inc. Visit our website for more info.</p>
        </div>
      </main>
