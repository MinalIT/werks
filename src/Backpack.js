    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Water Resistant Anti Theft Laptop Backpack/Office Backpack</h2>
            <p className="text-xl mt-2 text-green-600">₹1500.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Gear Vintage2 28L Medium Faux Water Resistant Anti Theft Laptop Backpack/Office Backpack for Men/Women (Black)
            </p>
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This water-resistant, anti-theft laptop backpack is designed for both functionality and style. Ideal for office use or casual outings, it features a spacious main compartment, multiple pockets for organization, and a sleek, modern design.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Gear Vintage2</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Faux Water Resistant Fabric</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">28L</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Features</td>
                <td className="p-2">Anti Theft, Water Resistant</td>
              </tr>
            </tbody>
          </table>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Gear Vintage2 is known for its high-quality backpacks designed to offer both durability and style. Our products are crafted to meet the needs of modern users, combining practical features with a sleek aesthetic.
          </p>
        </div>
      </main>
       ...
       <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Great Bag for casual use! Very comfortable and the minimalist design is perfect."</p>
