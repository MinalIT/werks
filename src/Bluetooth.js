    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Portable Bluetooth Speaker</h2>
            <p className="text-xl mt-2 text-green-600">₹2000.00 or 199.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Experience high-quality sound with this portable Bluetooth speaker, perfect for indoor and outdoor use.
            </p>
        ...
        <div className="bg-gray-100 p-10 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This portable Bluetooth speaker delivers powerful sound, perfect for any occasion. Its compact design allows you to carry it wherever you go.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">SoundPro</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Type</td>
                <td className="p-2">Portable</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Battery Life</td>
                <td className="p-2">Up to 12 hours</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">Black, Red, Blue</td>
              </tr>
            </tbody>
          </table>
