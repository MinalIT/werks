    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Bookcase Open Book Shelf Storage Cabinet</h2>
        ...
        <div className="bg-gray-100 p-3 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This Bookcase Open Book Shelf Storage Cabinet is designed to provide ample storage while adding a touch of modern style to any room. Crafted from high-quality engineered wood, it features a 6-tier open design that allows for versatile storage options. Ideal for books, decorations, or personal items, this bookshelf is easy to assemble and fits seamlessly into your home or office decor.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">Brown Oak</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Dimensions</td>
                <td className="p-2">136 x 24 x 71 cm</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Assembly Required</td>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Lukzer is a leading manufacturer of high-quality home and office furniture. We specialize in creating stylish, functional, and durable furniture pieces that enhance your living space. Our commitment to quality and customer satisfaction ensures that every product we offer meets the highest standards.
          </p>
        </div>
      </main>
      ...
      <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">Great quality bookshelf! Perfect for organizing my books and the wood finish looks elegant.</p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">Assembly was straightforward, and the bookshelf is sturdy. However, the color was slightly different from the picture.</p>
