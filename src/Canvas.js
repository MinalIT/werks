      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 px-4">
        <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 lg:pl-6">
            <h2 className="text-3xl font-bold text-gray-900">Canvas Tote Bag for Women</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2">
              Ecovation Canvas Tote Bag for Women, College Bag for Girls, 100% Organic Cotton Tote Bag for 
              Shopping, Travel, office & beach bags for women
            </p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg shadow-lg mt-6 lg:mt-0 lg:w-1/3">
          <h3 className="text-2xl font-bold mb-4">Product Description</h3>
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This Canvas Tote Bag is a versatile accessory designed for women on the go. Made from 100% organic cotton, it is durable and spacious enough for all your daily needs. Ideal for shopping, travel, office, or beach outings, this tote combines functionality with a chic look.
          </p>
          
          <h3 className="text-2xl font-bold mt-4 mb-2">Specifications</h3>
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Ecovation</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Organic Cotton</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">18 x 14 x 6 inches</td>
              </tr>
            </tbody>
          </table>

          <h3 className="text-2xl font-bold mt-4 mb-2">Company Info</h3>
          <p className="text-sm text-gray-700">
            Ecovation is committed to providing high-quality, eco-friendly products that make a positive impact on the environment. With a focus on sustainability and style, our products are designed to meet your needs while minimizing environmental impact.
          </p>
        </div>
      </main>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <StarIcon className="h-5 w-5 text-yellow-400 ml-1" />
              <StarIcon className="h-5 w-5 text-yellow-400 ml-1" />
              <StarIcon className="h-5 w-5 text-gray-300 ml-1" />
            </div>
            <p className="text-gray-700 mt-2">Great quality tote! Perfect for organizing my material and the wood finish looks elegant.</p>
            <p className="text-gray-500 mt-1 text-sm">- Sarah J.</p>
          </div>
          {/* Review 2 */}
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            <div className="flex items-center">
            ...
            <p className="text-gray-700 mt-2">Assembly was straightforward, and the canvas Tote is sturdy. However, the color was slightly different from the picture.</p>
            <p className="text-gray-500 mt-1 text-sm">- David K.</p>
          </div>
        </div>
      </section>
