    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Clutch Wallet Genuine Leather</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              mtuggar Women Clutch Wallet Genuine Leather (2805-BRN) in Creamy color. A sophisticated choice for any occasion.
            </p>
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This genuine leather clutch wallet is designed to be stylish and practical. Ideal for daily use or special occasions, it features a spacious interior and a sleek design. Made from high-quality materials, it offers durability and elegance.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">mtuggar</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Genuine Leather</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color</td>
                <td className="p-2">Creamy</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            mtuggar is known for its high-quality leather goods that combine style and functionality. Our products are crafted to offer durability and elegance. Each piece is meticulously designed to meet the highest standards of craftsmanship.
          </p>
        </div>
      </main>
      ...
      <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Great Clutch for casual use! Very comfortable and the minimalist design is perfect."</p>
