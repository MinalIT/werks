    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Dining Table</h2>
            <p className="text-xl mt-2 text-green-600">₹5000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Craftswood Solid Wood Dining Table and 4 Chairs with Cushion| Wooden Room Furniture Honey Finish
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This dining table is crafted from high-quality solid wood, offering durability and a sophisticated look. It comes with 4 matching chairs with cushions for added comfort. The honey finish adds a touch of elegance, making it a perfect addition to any dining area.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Craftswood</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Solid Wood</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color</td>
                <td className="p-2">Honey Finish</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Dimensions</td>
                <td className="p-2">150 x 90 x 75 cm</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Chairs</td>
                <td className="p-2">4 with Cushions</td>
              </tr>
            </tbody>
          </table>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Craftswood is a leading brand in furniture, known for its elegant designs and quality craftsmanship. Our products are made with attention to detail and are built to last, ensuring satisfaction and comfort for our customers.
          </p>
        </div>
      </main>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">
              “The dining table is beautiful and well-made. The honey finish is perfect, and it was easy to assemble. Highly recommend!”
            </p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">
              “Very sturdy and stylish dining table. It fits perfectly in my dining room and matches my other furniture well.”
            </p>
