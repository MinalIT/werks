    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Drone with 1080P Camera</h2>
            <p className="text-xl mt-2 text-green-600">₹10000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Drone with 1080P Camera for Beginners and Kids, Foldable Remote Control Quadcopter with Voice Control, 
              Gestures Selfie, Altitude Hold, One Key Start, 3D Flips, 2 Batteries, Toy for Boys Girls
            </p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-2xl font-bold mb-4">Product Description</h3>
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This drone offers an impressive 1080P camera with advanced features such as voice control, altitude hold, 
            and 3D flips. Ideal for beginners and kids, it includes two batteries for extended flying time.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">1080P</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Control</td>
                <td className="p-2">Voice Control, Remote Control</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Features</td>
                <td className="p-2">Altitude Hold, 3D Flips, Gestures Selfie</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Batteries</td>
                <td className="p-2">2 Included</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-2">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by XYZ Corp. For more information, visit our website or contact support.</p>
        </div>
      </main>
