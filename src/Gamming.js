      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">30000 Games in 1 Handheld Game Console</h2>
            <p className="text-xl mt-2 text-green-600">₹10000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              30000 Games in 1 Handheld Game Console, 3.5-Inch IPS Screen Retro Gaming Console, 
              30000 Classic Games, 3800mAh Battery, 20+ Mainstream Emulator, Built-in 256G TF Card, 
              Support HDMI and TV Output
            </p>
        ...
        <div className="bg-gray-100 p-10 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This gaming console offers an extensive library of 30000 games, a high-resolution screen, and various emulators, all packed into a compact, handheld device.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">RetroTech</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Model</td>
                <td className="p-2">G30000</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Screen</td>
                <td className="p-2">3.5-Inch IPS</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Battery</td>
                <td className="p-2">3800mAh</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Storage</td>
                <td className="p-2">256G TF Card</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-2">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by Google LLC. For more information, visit our website or contact support.</p>
        </div>
      </main>
