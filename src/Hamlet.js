      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">The Tragedy of Hamlet</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              The Tragedy of Hamlet, Prince of Denmark, usually shortened to Hamlet, is a tragedy written 
              by William Shakespeare sometime between 1599 and 1601.
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "The Tragedy of Hamlet" is designed to be a classic piece for any literature enthusiast. 
            A timeless work by William Shakespeare, it offers profound insights into human nature and drama.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">William Shakespeare</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Genre</td>
                <td className="p-2">Tragedy</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "Hamlet" is published by a reputable publisher known for its high-quality literary works. 
            It provides an authentic representation of Shakespeare's classic tragedy.
          </p>
        </div>
      </main>
       ...
       <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Amazing edition of Hamlet! The quality is top-notch, and it’s a must-have for any Shakespearean scholar."</p>
