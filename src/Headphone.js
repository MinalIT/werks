    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Noise-Canceling Headphones</h2>
            <p className="text-xl mt-2 text-green-600">₹1500.00 or 149.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Premium noise-canceling headphones with superior sound quality for an immersive experience.
            </p>
        ...
        <div className="bg-gray-100 p-20 rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-2xl font-bold mb-4">Product Description</h3>
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            These noise-canceling headphones offer an unmatched audio experience with premium sound and long battery life.
          </p>

          <h3 className="text-2xl font-bold mt-1 mb-4">Specifications</h3>
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Noise-X</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Type</td>
                <td className="p-2">Over-Ear</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Battery Life</td>
                <td className="p-2">Up to 24 hours</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color Options</td>
                <td className="p-2">Black, Blue</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Noise Cancellation</td>
                <td className="p-2">Yes</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-4">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by Noise-X. Visit our website for more info.</p>
        </div>
      </main>
      ...
      <div className="mt-4">
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mt-2">"Great shoe for running. Comfortable and lightweight!"</p>
                <p className="text-gray-500 mt-1">- Alex Johnson</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-md">
                <div className="flex items-center">
                  <StarIcon className="w-5 h-5 text-yellow-400" />
                ...
                <p className="text-gray-700 mt-2">"Good quality, but the size runs a bit small."</p>
                <p className="text-gray-500 mt-1">- Jessica Lee</p>
              </div>
            </div>
          </div>
    </div>
