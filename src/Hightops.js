    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">High Top Canvas Sneakers</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              ZGR Men's High Top Canvas Sneakers Lace Up Classic Casual Walking Shoes
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            ZGR Men's High Top Canvas Sneakers offer classic style and durable comfort for everyday wear. Ideal for casual outings with a timeless lace-up design.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">ZGR</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Canvas, Rubber Sole</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">High Top Sneakers</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-2">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by ZGR. For more information, visit our website or contact support.</p>
        </div>
      </main>
