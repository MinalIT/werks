    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Hobo Bag Big Ladies Purse Multiple Compartments</h2>
            <p className="text-xl mt-2 text-green-600">₹1500.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Storite Women’s Faux Leather Shoulder Handbags Hobo Bag Big Ladies Purse Multiple Compartments Tote Bag for Office and College with Long Strap – (Brown)
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This hobo bag features a spacious interior with multiple compartments, making it perfect for daily use or special occasions. Made from high-quality faux leather, it combines durability with a stylish design. Ideal for office, college, or casual outings.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Storite</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Faux Leather</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Storite is known for its high-quality faux leather handbags that combine style and functionality. Our products are crafted to offer both durability and elegance, with each piece designed to meet the highest standards of craftsmanship.
          </p>
        </div>
      </main>
...
<section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Great Hobo bag for casual use! Very comfortable and the minimalist design is perfect."</p>
