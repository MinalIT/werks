      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">HP 15s Laptop</h2>
            <p className="text-xl mt-2 text-green-600">₹10000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              HP 15s Laptop (AMD Ryzen 3 5300U / 8GB RAM/ 512 SSD/ 15.6 (39.6 cm) Display/ AMD Integrated Graphics/ Win 11/ Office) EQ2143AU
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This laptop offers a comprehensive computing experience with robust performance, a sleek design, and advanced features that cater to all your needs.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">HP</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Processor</td>
                <td className="p-2">AMD Ryzen 3 5300U</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">512 SSD</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Display</td>
                <td className="p-2">15.6 inches (39.6 cm)</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-2">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by HP Inc. For more information, visit our website or contact support.</p>
        </div>
      </main>
