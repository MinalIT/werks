    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">MacBook 13 Pro</h2>
            ...
            <p className="text-sm text-gray-500 mt-2 leading-6">
              ...
              The same compact design supports up to 20 hours of battery life and an active 
              cooling system to sustain enhanced performance. Featuring a brilliant Retina display, 
              a FaceTime HD camera, and studio‑quality mics, it’s our most portable pro laptop.
            </p>
        ...
        <div className="bg-gray-100 p-10 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            ...
            supports up to 20 hours of battery life and an active cooling system to sustain enhanced performance. 
            Featuring a brilliant Retina display, a FaceTime HD camera, and studio‑quality mics, it’s our most portable 
            pro laptop.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">M2 Chip</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Storage</td>
                <td className="p-2">256GB SSD</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Display</td>
                <td className="p-2">13.3" Retina Display</td>
              </tr>
              <tr className="border-t">
