    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Moby-Dick by Herman Melville</h2>
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "Moby-Dick" is a classic piece for any literature enthusiast. 
            A timeless work by Herman Melville, it offers profound insights into human nature and drama.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Herman Melville</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "Moby-Dick" is published by a reputable publisher known for its high-quality literary works. 
            It provides an authentic representation of Melville's classic novel.
          </p>
        </div>
      </main>
