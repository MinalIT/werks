      ...
      <main className="flex justify-center items-start py-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg flex w-2/3">
          ...
          <div className="w-full pl-6">
            <h2 className="text-3xl font-bold">Basics - 27 Inch IPS Monitor</h2>
            <p className="text-xl mt-2">₹5000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2">
              Amazon Basics - 27 Inch IPS Monitor 75 Hz Powered with AOC Technology FHD 1080P HDMI, 
              Display Port and VGA Input VESA Compatible Built-in Speakers for Office and Home, Black
            </p>
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-1/3 ml-6">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            The Amazon Basics - 27 Inch IPS Monitor is designed for optimal clarity and comfort. 
            It features a 75 Hz refresh rate and FHD 1080P resolution, providing crisp and vibrant visuals. 
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">FHD 1080P</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Refresh Rate</td>
                <td className="p-2">75 Hz</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Inputs</td>
                <td className="p-2">HDMI, Display Port, VGA</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Built-in Speakers</td>
