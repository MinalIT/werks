    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-6 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Pride and Prejudice by Jane Austen</h2>
            ...
            <p className="text-sm text-gray-500 mt-2">
              ...
              A novel of manners, it follows the character development of Elizabeth Bennet, the dynamic 
              and outspoken protagonist who navigates societal expectations and personal growth.
            </p>
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Pride and Prejudice is one of the most famous novels in English literature. This edition 
            includes detailed annotations and historical context to enhance your reading experience.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Jane Austen</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Published by a reputable house known for its classic literature editions. This version of 
            Pride and Prejudice is a beautiful addition to any bookshelf.
          </p>
        </div>
      </main>
