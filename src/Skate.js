    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Skate Shoes</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              JACKSHIBO Men's Slip in Hands-Free Barefoot Shoes Wide Toe Box Minimalist Walking Sneakers 
              Low Top Slip-On Casual Canvas Skate Shoes with Zero Drop Sole Comfortable
            </p>
        ...
        <div className="bg-gray-100 p-3 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            These skate shoes are designed for comfort, durability, and style. Whether you're performing tricks at the skatepark or just walking around town, these shoes provide excellent grip and flexibility. Made from high-quality canvas, they feature a minimalist design and a wide toe box for a comfortable fit.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">JACKSHIBO</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Canvas, Rubber</td>
              </tr>
              <tr className="border-t">
              ...
              <tr className="border-t">
                ...
                <td className="p-2">7, 8, 9, 10, 11</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Sole</td>
                <td className="p-2">Zero Drop Sole</td>
              </tr>
            </tbody>
          </table>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            JACKSHIBO is a renowned brand in the footwear industry, known for producing high-quality, durable, and comfortable shoes. Our products are designed with both functionality and style in mind, ensuring that every customer feels confident and comfortable in their shoes.
          </p>
        </div>
      </main>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Great shoes for casual use! Very comfortable and the minimalist design is perfect."</p>
