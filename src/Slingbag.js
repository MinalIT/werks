    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Sling Bag</h2>
            <p className="text-xl mt-2 text-green-600">₹1200.00 or 200.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Elegant sling bag suitable for various occasions. Designed with high-quality materials for durability.
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This sling bag is crafted with premium materials for style and durability. Perfect for daily use or special occasions. Features a spacious interior and sleek design.
          </p>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Company X has been a leader in fashion accessories for over a decade. We are committed to providing high-quality products and exceptional customer service.
          </p>
      ...
      <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-700">"Great Clutch for Sling Bag use! Very comfortable and the minimalist design is perfect."</p>
