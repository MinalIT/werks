      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">I KALL Z6 Pro 4GB/64GB Green 4G Smartphone</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              The I KALL Z6 Pro 4GB/64GB Green 4G Smartphone is a great choice for anyone looking for a powerful and
              stylish smartphone. This phone has a 4GB RAM and a 64GB storage capacity, making it the only choice for
              storing your photos, music, and other files. The I Kall Z6 Pro is a perfect amalgamation of style and substance.
        ...
        <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This smartwatch offers a comprehensive fitness tracking experience with notifications, health monitoring, and a stylish design that fits any occasion.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">TechPro</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Silicone, Metal</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color</td>
                <td className="p-2">Red, Black, Blue</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Size</td>
                <td className="p-2">One Size</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Battery Life</td>
                <td className="p-2">Up to 7 days</td>
              </tr>
            </tbody>
          </table>
          <h3 className="text-2xl font-bold mt-4 mb-2">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by TechPro Inc. under the official product line. For more information, visit our website or contact support.</p>
          With a 6.26 inch HD+ display,
          and a resolution of 720x1520, this device is the only choice for watching videos, movies and gaming.</div>
      </main>
