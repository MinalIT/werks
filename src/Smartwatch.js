...
import watchred from './Images/watchred.png';
import watchblack from './Images/watchblack.png';
...
const ProductPage = () => {
    ...
    const [selectedColor, setSelectedColor] = useState(watchred);
            ...
            <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
                ...
                <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <div className="flex space-x-4 mt-4">
                            <button
                                ...
                                onClick={() => changeColor(watchred)}
                            ></button>
                            <button
                                className="w-10 h-10 rounded-full bg-black"
                                onClick={() => changeColor(watchblack)}
                            ></button>
                            <button
                                className="w-10 h-10 rounded-full bg-blue-500"
                                onClick={() => changeColor(watchblue)}
                            ></button>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <p className="text-xl mt-2 text-green-600">₹5,000.00 or 999.99/month</p>
                        <p className="text-sm text-gray-500 mt-2 leading-6">
                            This advanced smartwatch offers fitness tracking, notifications, and a sleek design. Perfect for staying connected and monitoring your health.
                        </p>
