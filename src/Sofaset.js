...
import sofared from './Images/sofared.png';
import sofagray from './Images/sofagray.png';
import sofablue from './Images/sofablue.png';
...
const ProductPage = () => {
    ...
    const [selectedColor, setSelectedColor] = useState(sofared);
        ...
        <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
                ...
                <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <div className="flex space-x-4 mt-4">
                            <button
                                ...
                                onClick={() => changeColor(sofared)}
                            ></button>
                            <button
                                className="w-10 h-10 rounded-full bg-gray-500"
                                onClick={() => changeColor(sofagray)}
                            ></button>
                            <button
                                className="w-10 h-10 rounded-full bg-blue-500"
                                onClick={() => changeColor(sofablue)}
                            ></button>
                        </div>
                    </div>
                    ...
                    {/* Product Info */}
                    <div className="w-full lg:w-1/2">
                        <h2 className="text-3xl font-bold text-gray-900">Comfortable Sofa Set</h2>
                        <p className="text-xl mt-2 text-green-600">₹20,000.00 or 2,000.00/month</p>
                        <p className="text-sm text-gray-500 mt-2 leading-6">
                            This elegant sofa set features plush cushioning, a modern design, and durable fabric, making it the perfect addition to any living space. Enjoy both comfort and style with this premium sofa set.
                        </p>
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <button className="p-2 bg-gray-200 rounded-lg hover:bg-gray-300">+</button>
                            <span className="text-red-500 ml-4">Only 5 sets left!</span>
                        </div>
              ...
              >
                ...
                <div className="bg-gray-100 p-3 rounded-lg shadow-lg w-full lg:w-1/3">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed text-justify">
                        This sofa set provides a luxurious seating experience with its comfortable cushions and stylish design. Perfect for any modern living room, it is crafted with high-quality materials to ensure durability and long-lasting comfort.
                    </p>
                    ...
                    <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
                        <tbody>
                            <tr className="border-t">
                                ...
                                <td className="p-2">Luxura</td>
                            </tr>
                            <tr className="border-t">
                                <td className="p-2 font-semibold">Material</td>
                                <td className="p-2">Fabric, Wood</td>
                            </tr>
                            <tr className="border-t">
                                <td className="p-2 font-semibold">Color</td>
                                <td className="p-2">Red, Gray, Blue</td>
                            </tr>
                            <tr className="border-t">
                                <td className="p-2 font-semibold">Size</td>
                                <td className="p-2">3-Seater, 2-Seater</td>
                            </tr>
                            <tr className="border-t">
                                <td className="p-2 font-semibold">Assembly</td>
                                <td className="p-2">Self Assembly Required</td>
                            </tr>
                        </tbody>
                    </table>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            JACKSHIBO is a renowned brand in the Sofaset industry, known for producing high-quality, durable, and comfortable sofa. 
          </p>
