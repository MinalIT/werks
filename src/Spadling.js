    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Spalding Flight Lines Rubber Basketball (Size-7), Multicolor</h2>
        ...
        <div className="bg-gray-100 p-14 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Spalding Rebound Professional Match Ball for Indoor/Outdoor Play Rubber Moulded Basketball for Women Men Youths. Designed for ultimate performance, 
            this basketball features a durable construction that handles both outdoor and indoor play. Ideal for players of all skill levels.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">Multicolor</td>
              </tr>
            </tbody>
          </table>
           {/* Publisher Info */}
