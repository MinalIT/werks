...
import stigaTableTennis from './Images/stigaTableTennis.png'; // Replace with your image path
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <img
              src={stigaTableTennis}
              alt="Stiga Table Tennis"
              className="w-full object-cover rounded-lg hover:scale-105 transition-transform"
            />
          </div>
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Stiga Table Tennis Set</h2>
            <p className="text-xl mt-2 text-green-600">₹15000.00 or 299.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Stiga Table Tennis Set with 2 Paddles and 3 Balls. Ideal for professional and recreational use.
            </p>
            ...
            <div className="flex items-center mt-4">
              ...
              <button className="p-2 bg-gray-200 rounded-lg hover:bg-gray-300">+</button>
              <span className="text-red-500 ml-4">Only 8 items left!</span>
            </div>
        ...
        <div className="bg-gray-100 p-14 rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-2xl font-bold mb-1">Product Description</h3>
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            The Stiga Table Tennis Set is perfect for enthusiasts and professionals alike. It includes high-quality paddles and balls that ensure excellent performance and durability. Enhance your game with this comprehensive set.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Stiga</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Material</td>
                <td className="p-2">Wood & Rubber</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Includes</td>
                <td className="p-2">2 Paddles, 3 Balls</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Color</td>
                <td className="p-2">Black/Red</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Weight</td>
                <td className="p-2">1.2 Kg</td>
              </tr>
            </tbody>
          </table>
          {/* Publisher Info */}
          <h3 className="text-2xl font-bold mt-1 mb-1">Publisher Info</h3>
          <p className="text-sm text-gray-700">Published by Stiga Sports. Visit our website for more details.</p>
        </div>
      </main>
