...
import min from './Images/1984.png';
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">1984: A Novel, unleashes a unique plot as per which No One is Safe or Free.</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              1984: A Novel, unleashes a unique plot as per which No One is Safe or Free. 
              No place is safe to run or even hide from a dominating party leader, Big Brother.
            </p>
        ...
        <div className="bg-gray-100 p-10 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "1984" captures the essence of a dystopian future with insightful annotations 
            and a detailed narrative, offering a compelling read for literature enthusiasts.
          </p>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Published by a renowned publisher known for its classic literary collections, this edition 
            of "1984" is a beautifully crafted version of Orwell's timeless novel.
          </p>
        </div>
      </main>
