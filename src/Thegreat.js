    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">The Great Gatsby by F. Scott Fitzgerald</h2>
            ...
            <p className="text-sm text-gray-500 mt-2 leading-6">
              ...
              Set in the Jazz Age on Long Island, near New York City, it depicts the life and times of Jay Gatsby 
              and his obsession with the beautiful Daisy Buchanan.
            </p>
        ...
        <div className="bg-gray-100 p-10 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "The Great Gatsby" captures the essence of the Jazz Age with insightful annotations 
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">F. Scott Fitzgerald</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            ...
            of "The Great Gatsby" is a beautifully crafted version of Fitzgerald's timeless novel.
          </p>
        </div>
      </main>
