    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">TV Stand and Home Entertainment Unit</h2>
        ...
        <div className="bg-gray-100 p-3 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This TV Stand and Home Entertainment Unit is designed to add elegance and functionality to your living space. Crafted from high-quality engineered wood, it features a matte finish and ample storage space for all your entertainment needs. The modern design fits seamlessly into any décor, making it a perfect addition to your home.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              ...
              <tr className="border-t">
                ...
                <td className="p-2">Wenge</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Dimensions</td>
                <td className="p-2">48 x 16 x 20 inches</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Finish</td>
                <td className="p-2">Matte</td>
              </tr>
            </tbody>
          </table>
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            DeckUp is known for crafting stylish and durable furniture that enhances your living space. Our products are designed with both aesthetics and functionality in mind, ensuring that you get quality and style in every piece.
          </p>
        </div>
      </main>
     ...
     <section className="bg-white p-1 mt-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">Great quality Tv Stand! Perfect for organizing my Tv and the wood finish looks elegant.</p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">Assembly was straightforward, and the Tv Stand is sturdy. However, the color was slightly different from the picture.</p>
