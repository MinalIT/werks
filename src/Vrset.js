    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">VR Headset for iPhone & Android</h2>
            <p className="text-xl mt-2 text-green-600">₹10000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              VR Headset for iPhone & Android + Android Remote 1.0 - for Kids | with Links to 3D VR Videos + VR Games for Android | 
              Virtual Reality Goggles Set for Phones 4.5"-6.5" – Blue
            </p>
        ...
        <div className="bg-gray-100 p-12 rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-2xl font-bold mb-4">Product Description</h3>
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This VR headset offers an immersive virtual reality experience with high-quality visuals and comfort for extended use. Compatible with both iPhone and Android devices.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                <td className="p-2 font-semibold">Compatibility</td>
                <td className="p-2">iPhone & Android</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Included Accessories</td>
                <td className="p-2">Android Remote 1.0</td>
              </tr>
              <tr className="border-t">
