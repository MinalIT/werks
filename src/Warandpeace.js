    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-8 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          {/* Product Info */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">War and Peace by Leo Tolstoy</h2>
            <p className="text-xl mt-2 text-green-600">₹1000.00 or 99.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              War and Peace is a literary work by Russian author Leo Tolstoy. 
              Set during the Napoleonic Wars, the work mixes fictional narrative with historical detail.
            </p>
        ...
        <div className="bg-gray-100 p-2 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "War and Peace" offers an insightful narrative of the Napoleonic Wars and the impact on Russian society, enriched with Tolstoy's profound storytelling.
          </p>
          ...
          <table className="w-full bg-white shadow-md rounded-lg table-fixed text-left text-sm">
            <tbody>
              <tr className="border-t">
                ...
                <td className="p-2">Leo Tolstoy</td>
              </tr>
              <tr className="border-t">
                <td className="p-2 font-semibold">Genre</td>
                <td className="p-2">Historical Fiction</td>
              </tr>
              <tr className="border-t">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            This edition of "War and Peace" is published by a renowned publisher known for its classic literary works. It presents Tolstoy's masterpiece with great fidelity.
          </p>
        </div>
      </main>
