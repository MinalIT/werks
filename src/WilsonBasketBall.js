      ...
      <main className="flex flex-col lg:flex-row justify-center items-start py-4 space-y-10 lg:space-y-0 lg:space-x-6 px-4">
        ...
        <div className="flex flex-col lg:flex-row lg:w-2/3 lg:h-fit space-y-6 lg:space-y-10 lg:space-x-6 bg-white p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full lg:w-1/2">
            <img
              src={wilsonBasketball}
              alt="Wilson Basketball"
              className="w-full object-cover rounded-lg hover:scale-105 transition-transform"
            />
          </div>
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900">Wilson Basketball</h2>
            <p className="text-xl mt-2 text-green-600">₹50000.00 or 999.99/month</p>
            <p className="text-sm text-gray-500 mt-2 leading-6">
              Wilson Basketball GAMBREAKER Basketball BLTE SZ7. Perfect for outdoor and indoor play, 
              this durable basketball is designed for both performance and comfort.
            </p>
        ...
        <div className="bg-gray-100 p-14 rounded-lg shadow-lg w-full lg:w-1/3">
          ...
          <p className="text-sm text-gray-700 leading-relaxed text-justify">
            Wilson Basketball GAMBREAKER Basketball BLTE SZ7. Designed for ultimate performance, 
            this basketball features a durable construction that handles both outdoor and indoor play. 
          ...
          <p className="text-sm text-gray-700">Published by Wilson Sporting Goods Co. Visit our website for more info.</p>
        </div>
      </main>
